#Given a two list of numbers create a new list such that new list should contain only odd numbers from
#  the first list and even numbers from the second list.
# Given lists
listOne = [10, 20, 23, 11, 17, 18, 99]
listTwo = [13, 43, 24, 36, 12, 11, 99]

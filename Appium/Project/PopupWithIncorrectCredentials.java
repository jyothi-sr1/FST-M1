...
public class PopupWithIncorrectCredentials {
		...
		// Driver Initialization
			...
			public void CorrectCredentials() {
		     ...
		     // UiScrollable object string
		       ...
		       driver.findElement(AppiumBy.androidUIAutomator(UiScrollable + ".scrollForward(30)"));
	        ...
	        wait.until(ExpectedConditions.visibilityOfElementLocated(
	         ...
	         WebElement successMessage = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@resource-id=\"action-confirmation\"]"));
	         Assert.assertTrue(successMessage.isDisplayed(), "Invalid Credentials");
	        }

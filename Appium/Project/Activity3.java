	    ...
	    public void taskTest() {
	     ...
	     // Enter the details
	        ...
	        WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(
	        	    AppiumBy.xpath("//android.widget.TextView[contains(@resource-id, 'com.google.android.keep:id/menu_text') and @text='Tomorrow morning']")
	        	));
	        element.click();
		 ...
		 // Step 7: Assert that the note with the reminder is present in the Reminders page
	        ...
	        System.out.println("Test Passed: The note with reminder is displayed in the Reminders tab.");
